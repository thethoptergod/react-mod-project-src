        ...
        <>
            ...
            ` ,maxWidth: 800, gridArea: "rev"}}>
                <div className="revText" style={{gridArea: "text"}}>
                    Smooth Ambler Contradiction, like the name suggests, is a bit of a contradiction. It is made of a blend of their own wheated West Virginia bourbon, and rye whiskey from Tennessee and Indiana. This makes for an amazing whiskey, 
                    pitting the sweetness of the wheated base against the rye spice. It starts as a sweet, oaky whiskey, but a few drops of water make the rye explode into existence, creating an amazing drinking experience.
                </div>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
            <img onClick={() => {setVisible(!visible); setButton(!button)}} src={url} id="map" alt='Smooth Ambler 745 Industrial Park Rd, Maxwelton, WV 24957' style={{display: 'block'}}></img>
            </div>
            </div>
            </div>
        </>
